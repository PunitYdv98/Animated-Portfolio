...
export const home = [
  {
    ...
    post: "SDE-1",
    design: "WEB DESIGNER",
    desc: "A passionate and dedicated web developer with a strong foundation in HTML, CSS, JavaScript, and React. Skilled in building responsive, user-friendly websites with a focus on clean design and functionality. Eager to learn new technologies and contribute to innovative projects in a dynamic development environment.",
  },
]
export const about = [
  {
